...
const App = () => {
    ...
    const [responseHeaders, setResponseHeaders] = useState<AxiosResponseHeaders | Partial<Record<string, string> & { "set-cookie"?: string[] | undefined }>>()
    ...
    return (
        <>
            <Typography variant='h2' style={{ width:'max-content', marginInline: 'auto', marginBlock: '1.5rem' }}>POSTMAN</Typography>
